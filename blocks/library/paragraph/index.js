...
registerBlockType( 'core/paragraph', {
	...
	edit( { attributes, setAttributes, insertBlocksAfter, focus, setFocus, mergeBlocks, onReplace } ) {
		...
		return [
			...
			focus && (
				<InspectorControls key="inspector" identifier="inspector-paragraph">
					<BlockDescription>
					...
					<PanelColor title={ __( 'Background Color' ) } colorValue={ backgroundColor } initialOpen={ false } key="panel-color-paragraph-1">
						<ColorPalette
							value={ backgroundColor }
							onChange={ ( colorValue ) => setAttributes( { backgroundColor: colorValue } ) }
						/>
					</PanelColor>
					<PanelColor title={ __( 'Text Color' ) } colorValue={ textColor } initialOpen={ false } key="panel-color-paragraph-2">
						<ColorPalette
							value={ textColor }
