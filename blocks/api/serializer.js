 ...
 */
import { isEmpty, reduce, castArray, compact } from 'lodash';
 ...
 *
 * @param  {Object}               save       Block type savee function
...
export function getBlockContent( block ) {
	...
	if ( block.isValid ) {
		try {
			saveContent = getSaveContent( blockType.save, block.attributes );
		} catch ( error ) {}
	}
